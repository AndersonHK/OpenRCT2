"""Build only the diagnostic terrain compute entry point, with strict receipts.
...
INPUTS = (
    ...
    'src/openrct2-renderer/gpu/TerrainSurfaceEmission.h',
    'src/openrct2-renderer/gpu/TerrainSurfaceRules.h',
    'test/tests/TerrainSurfaceEmissionTests.cpp',
...
def main():
    ...
    shader = output / 'TerrainSurfaceRulesProbe.comp.spv'
    ...
    receipt = {'schema': 1, 'status': 'pass' if passed else 'fail', 'commands': commands, 'exitCodes': codes,
               ...
               'scope': 'Diagnostic-only compute shader compile; no GPU execution, production shader registration or terrain admission.'}
