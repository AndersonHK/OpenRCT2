"""Build the retained terrain emission compute entry point for diagnostic qualification, with strict receipts.
...
def main():
    ...
    shader = output / 'terrain_retained_emit.comp.spv'
    ...
    receipt = {'schema': 1, 'status': 'pass' if passed else 'fail', 'commands': commands, 'exitCodes': codes,
               ...
               'scope': 'Retained emission compute shader compile for explicit diagnostic use; no GPU execution, production shader registration or terrain admission.'}
