...
namespace OpenRCT2::Ui::Vulkan
{
    ...
    public:
        ...
        void Initialise(VkPhysicalDevice physicalDevice, VkDevice device, VkDeviceSize size, VkBufferUsageFlags usage);
        void Dispose();
    ...
    public:
        ...
        void Initialise(
            ...
            VkImageUsageFlags usage, VkImageAspectFlags aspect, bool forceArrayView = false);
        void Dispose();
    ...
    private:
        ...
        bool _submittedAtlasHasShaderLayout = false;
        bool _submittedRemapPaletteHasShaderLayout = false;
        bool _submittedBlendPaletteHasShaderLayout = false;
        bool _submittedLightFalloffsHaveShaderLayout = false;
        ...
        uint32_t _atlasLayers = Gpu::kAtlasLayers;
    ...
    public:
        ...
        void Initialise(
            const DeviceContext& device, Gpu::Extent logicalExtent, bool createLightAccumulators,
            uint32_t frameCount = kFramesInFlight, uint32_t atlasLayers = Gpu::kAtlasLayers);
        uint32_t GetFrameCount() const noexcept
        {
            return _frameCount;
        }
        uint32_t GetAtlasLayers() const noexcept
        {
            return _atlasLayers;
        }
        void Dispose();
        ...
        void CommitFrameLayouts() noexcept;
        void EnsureAtlasShaderLayout(VkCommandBuffer commandBuffer);
        ...
        void RecordPaletteUpload(VkCommandBuffer commandBuffer, uint32_t frameIndex, const UploadAllocation& allocation);
        void RecordIndexTableUpload(VkCommandBuffer commandBuffer, const UploadAllocation& allocation, bool blend);
        ...
        void RecordInitialIndices(VkCommandBuffer commandBuffer, uint32_t frameIndex, const UploadAllocation& allocation);
    ...
    private:
        ...
        void RecordDepthClear(VkCommandBuffer commandBuffer, uint32_t frameIndex);
        ...
        void RecordImageUpload(
            VkCommandBuffer commandBuffer, const UploadAllocation& allocation, Image& image, bool& hasShaderLayout,
            const VkBufferImageCopy& copy, uint32_t bytesPerPixel = 1);
    };
