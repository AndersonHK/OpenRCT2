...
namespace OpenRCT2::Ui::Vulkan
{
    ...
    inline constexpr std::array kRectCommandAttributes = {
        ...
        VkVertexInputAttributeDescription{ 2, 0, VK_FORMAT_R32G32B32A32_SFLOAT, offsetof(Gpu::RectCommand, texColourBounds) },
        VkVertexInputAttributeDescription{ 3, 0, VK_FORMAT_R32_SINT, offsetof(Gpu::RectCommand, texMaskAtlas) },
        VkVertexInputAttributeDescription{ 4, 0, VK_FORMAT_R32G32B32A32_SFLOAT, offsetof(Gpu::RectCommand, texMaskBounds) },
