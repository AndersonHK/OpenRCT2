...
namespace OpenRCT2
{
    ...
    using SpecialElementRatingAdjustmentFunc = void (*)(
    ...
    struct RideTypeDescriptor
    {
        ...
        SpecialElementRatingAdjustmentFunc SpecialElementRatingAdjustment = SpecialTrackElementRatingsAdjustment_Default;
        ...
        RideUpdateMeasurementsSpecialElementsFunc UpdateMeasurementsSpecialElements
            = RideUpdateMeasurementsSpecialElements_Default;
