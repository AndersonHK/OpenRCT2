...
namespace OpenRCT2
{
    constexpr auto kPeepActionToStringMapping = std::to_array<StringId>({
        ...
        STR_WALKING_TO_PLATFORM_FOR,             // PeepActionDescriptionType::walkingToPlatform
        STR_WAITING_ON_PLATFORM_FOR,             // PeepActionDescriptionType::waitingOnPlatform
    });
    ...
    void formatPeepActionTo(const Peep& peep, Formatter& ft)
    {
        ...
        {
            case PeepActionDescriptionType::headingFor:
            case PeepActionDescriptionType::watchingRide:
            case PeepActionDescriptionType::watchingRideConstruction:
            case PeepActionDescriptionType::queuingFor:
            case PeepActionDescriptionType::onRide:
            case PeepActionDescriptionType::inRide:
            case PeepActionDescriptionType::atShop:
            case PeepActionDescriptionType::headingToInspectRide:
            case PeepActionDescriptionType::inspectingRide:
            case PeepActionDescriptionType::fixingRide:
            case PeepActionDescriptionType::respondingToBreakdownCall:
            case PeepActionDescriptionType::walkingToPlatform:
            case PeepActionDescriptionType::waitingOnPlatform:
                if (const auto* ride = GetRide(description.rideId))
