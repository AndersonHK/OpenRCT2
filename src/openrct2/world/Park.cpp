...
namespace OpenRCT2::Park
{
    ...
    {
        constexpr money64 kGuestGenerationBaselineParkValue = 11000.00_GBP;
        ...
        // Keep the tuned probability at $11,000 park value, then scale geometrically from park value.
        if (park.value <= 0)
        {
            probability = 0;
        }
