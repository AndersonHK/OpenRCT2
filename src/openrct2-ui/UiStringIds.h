...
namespace OpenRCT2
{
    enum : StringId
    {
        ...
        STR_ADMISSION_PRICE_TARGET_RICHEST_GUEST = 7076,
        STR_ADMISSION_PRICE_TARGET_MAX_PROFIT = 7077,
        STR_ADMISSION_PRICE_TARGET_ALL_GUESTS = 7078,
        STR_SELECT_ADMISSION_PRICING_POLICY = 7079,
        STR_ADMISSION_PRICING_POLICY_TIP = 7080,
        ...
        STR_MAX_NEGATIVE_LONGITUDINAL_G = 7045,
        STR_TRANSPORT_SERVICE_QUALITY = 7048,
        STR_TRANSPORT_COMFORT = 7049,
        STR_TRANSPORT_COMFORT_ESTIMATED = 7050,
        STR_TRANSPORT_DECORATION_BONUS = 7051,
        STR_TRANSPORT_DECORATION_BONUS_ESTIMATED = 7052,
        STR_TRANSPORT_SEGMENT_FARE = 7053,
        STR_RIDE_RATING_LEGS = 7059,
        STR_RIDE_RATING_LEG_DISTANCE = 7060,
        STR_RIDE_RATING_LEG_DURATION = 7061,
        STR_RIDE_GLOBAL_MEASUREMENTS = 7062,
        STR_RIDE_RATING_LEG_OPTION = 7063,
        STR_RIDE_RATING_LEGS_NOT_YET_AVAILABLE = 7064,
        STR_RIDE_RATING_LEG_SELECT_TIP = 7065,
        STR_RIDE_PRICE_TARGET_DISCOUNT = 7068,
        STR_RIDE_PRICE_TARGET_FAIR = 7069,
        STR_RIDE_PRICE_TARGET_EXPENSIVE = 7070,
        STR_TRANSPORT_PRICE_TARGET_FREE = 7071,
        STR_TRANSPORT_PRICE_TARGET_DISCOUNT = 7072,
        STR_TRANSPORT_PRICE_TARGET_FAIR = 7073,
        STR_TRANSPORT_PRICE_TARGET_EXTORTIVE = 7074,
        STR_RIDE_PRICE_TARGET_WAITING_FOR_RATING = 7075,
        STR_ENABLE_HDR10_OUTPUT = 7066,
        STR_ENABLE_HDR10_OUTPUT_TIP = 7067,
        STR_MAZE_CAPACITY_MODE = 7039,
        STR_MAZE_CAPACITY_MODE_TIP = 7040,
        STR_MAZE_CAPACITY_SPARSE = 7041,
        STR_MAZE_CAPACITY_NORMAL = 7042,
        STR_MAZE_CAPACITY_OVERCROWDING = 7043,
        ...
        STR_MAX_POSITIVE_LONGITUDINAL_G = 7044,
        STR_MAX_SPEED = 1340,
        ...
        STR_SHOW_GRAPH_OF_LONGITUDINAL_ACCELERATION_AGAINST_TIME_TIP = 7047,
