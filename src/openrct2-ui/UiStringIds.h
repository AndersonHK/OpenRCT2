...
namespace OpenRCT2
{
    enum : StringId
    {
        ...
        STR_MAX_NEGATIVE_LONGITUDINAL_G = 7039,
        STR_TRANSPORT_SERVICE_QUALITY = 7042,
        STR_TRANSPORT_COMFORT = 7043,
        STR_TRANSPORT_COMFORT_ESTIMATED = 7044,
        STR_TRANSPORT_DECORATION_BONUS = 7045,
        STR_TRANSPORT_DECORATION_BONUS_ESTIMATED = 7046,
        STR_TRANSPORT_SEGMENT_STATS = 7047,
        STR_RIDE_RATING_LEGS = 7053,
        STR_RIDE_RATING_LEG_STATS = 7054,
        STR_RIDE_RATING_COMPATIBILITY_SUMMARY = 7055,
        STR_RIDE_RATING_LEG_MEASUREMENTS = 7056,
        STR_RIDE_RATING_LEG_G_FORCES = 7057,
        STR_RIDE_GLOBAL_MEASUREMENTS = 7058,
        STR_RIDE_RATING_LEG_OPTION = 7059,
        STR_RIDE_RATING_LEGS_NOT_YET_AVAILABLE = 7060,
        STR_RIDE_RATING_LEG_SELECT_TIP = 7061,
        STR_TRANSPORT_LEG_QUALITY = 7062,
        STR_MAZE_CAPACITY_MODE = 7033,
        STR_MAZE_CAPACITY_MODE_TIP = 7034,
        STR_MAZE_CAPACITY_SPARSE = 7035,
        STR_MAZE_CAPACITY_NORMAL = 7036,
        STR_MAZE_CAPACITY_OVERCROWDING = 7037,
        ...
        STR_MAX_POSITIVE_LONGITUDINAL_G = 7038,
        STR_MAX_SPEED = 1340,
        ...
        STR_SHOW_GRAPH_OF_LONGITUDINAL_ACCELERATION_AGAINST_TIME_TIP = 7041,
