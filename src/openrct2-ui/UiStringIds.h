...
namespace OpenRCT2
{
    enum : StringId
    {
        ...
        STR_ADMISSION_PRICE_TARGET_RICHEST_GUEST = 8037,
        STR_ADMISSION_PRICE_TARGET_MAX_PROFIT = 8038,
        STR_ADMISSION_PRICE_TARGET_ALL_GUESTS = 8039,
        STR_SELECT_ADMISSION_PRICING_POLICY = 8040,
        STR_ADMISSION_PRICING_POLICY_TIP = 8041,
        ...
        STR_MAX_NEGATIVE_LONGITUDINAL_G = 8006,
        STR_TRANSPORT_SERVICE_QUALITY = 8009,
        STR_TRANSPORT_COMFORT = 8010,
        STR_TRANSPORT_COMFORT_ESTIMATED = 8011,
        STR_TRANSPORT_DECORATION_BONUS = 8012,
        STR_TRANSPORT_DECORATION_BONUS_ESTIMATED = 8013,
        STR_TRANSPORT_SEGMENT_FARE = 8014,
        STR_RIDE_RATING_LEGS = 8020,
        STR_RIDE_RATING_LEG_DISTANCE = 8021,
        STR_RIDE_RATING_LEG_DURATION = 8022,
        STR_RIDE_GLOBAL_MEASUREMENTS = 8023,
        STR_RIDE_RATING_LEG_OPTION = 8024,
        STR_RIDE_RATING_LEGS_NOT_YET_AVAILABLE = 8025,
        STR_RIDE_RATING_LEG_SELECT_TIP = 8026,
        STR_RIDE_PRICE_TARGET_DISCOUNT = 8029,
        STR_RIDE_PRICE_TARGET_FAIR = 8030,
        STR_RIDE_PRICE_TARGET_EXPENSIVE = 8031,
        STR_TRANSPORT_PRICE_TARGET_FREE = 8032,
        STR_TRANSPORT_PRICE_TARGET_DISCOUNT = 8033,
        STR_TRANSPORT_PRICE_TARGET_FAIR = 8034,
        STR_TRANSPORT_PRICE_TARGET_EXTORTIVE = 8035,
        STR_RIDE_PRICE_TARGET_WAITING_FOR_RATING = 8036,
        STR_ENABLE_HDR10_OUTPUT = 8027,
        STR_ENABLE_HDR10_OUTPUT_TIP = 8028,
        STR_MAZE_CAPACITY_MODE = 8000,
        STR_MAZE_CAPACITY_MODE_TIP = 8001,
        STR_MAZE_CAPACITY_SPARSE = 8002,
        STR_MAZE_CAPACITY_NORMAL = 8003,
        STR_MAZE_CAPACITY_OVERCROWDING = 8004,
        ...
        STR_MAX_POSITIVE_LONGITUDINAL_G = 8005,
        STR_MAX_SPEED = 1340,
        ...
        STR_SHOW_GRAPH_OF_LONGITUDINAL_ACCELERATION_AGAINST_TIME_TIP = 8008,
        ...
        STR_THEMES_WINDOW_EDITOR_STEP_CONTROL_SCENARIO = 7048,
        STR_THEMES_WINDOW_EDITOR_STEP_CONTROL_TRACK = 7047,
