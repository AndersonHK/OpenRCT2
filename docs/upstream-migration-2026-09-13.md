...
- **Fork receipt:** `b65b08504b0761ef22e3ee4ea644c3ddc43029ce`.
- **Remaining:** 156 → 155.
- **Disposition:** adopt applicable changes.
...
### U207 — `3768b08999` — Request user attention when the save prompt blocks quitting (#26933)

- **Source:** `3768b089990e75c298e359d85118043a86e821a6`.
- **Fork receipt:** `300af2ea32b2beded7333a68ea0f82cd22a72af3`.
- **Remaining:** 155 → 154.
- **Disposition:** adopt applicable changes.
- **Manual changes:** Request SDL desktop attention until focused when an OS quit request opens a blocking save prompt in an unfocused window; add UI interface and headless no-op.
- **Additional decisions / behavior:** Adopt exact source logic. Existing title/confirmation/invalid-mode early exits and fork save-prompt age threshold, focus/pause/audio policies unchanged. No forced focus and no new owner choice.
- **Verification:** Inspected full five-file source and fork SavePromptOpen branch; both concrete IUiContext implementations updated. Diff check passes.
- **Pending / concerns:** Compile next batch; actual Windows taskbar/Linux urgency/macOS dock behavior and OS quit session interaction unverified.
...
- **Fork receipt:** `65c3da47955524f76f43367da8f3dbee9dfdc692`.
- **Remaining:** 150 → 149.
- **Disposition:** adopt applicable changes.
...
- **Fork receipt:** `52dcd150884c498601b8e804ba287ee645f07119`.
- **Remaining:** 144 → 143.
- **Disposition:** adopt applicable changes.
...
- **Fork receipt:** `8644bf5556bf86b52acbf0f16ccc39b8366a7490`.
- **Remaining:** 135 → 134.
- **Disposition:** adopt applicable changes.
...
- **Fork receipt:** `68dcd12bf2456fba67f5622313bbb03540ff6f9f`.
- **Remaining:** 131 → 130.
- **Disposition:** adopt applicable changes.
...
### U232 — `a5edcd5780` — Rename RCT1ResearchFlagsSeparator to kRCT1ResearchFlagsSeparator

- **Source:** `a5edcd5780ab9749bb138d9b6af0be0de5abb1d5`.
- **Fork receipt:** `5af2c583e5eeda3ac8f407339da5906e8759d8c8`.
- **Remaining:** 130 → 129.
- **Disposition:** adopt applicable changes.
- **Manual changes:** Rename the RCT1 research separator constant and its four importer uses.
- **Additional decisions / behavior:** Keep numeric separator 0xFF, research ordering and all fork importer behavior.
- **Verification:** Complete source and repository references reviewed; inverse replacement reproduces original file contents.
- **Pending / concerns:** U229–U232 compile at next checkpoint.

### U233 — `65dfdd3030` — Rename MASK_SIZE to kMaskSize

- **Source:** `65dfdd3030bfe5da17cc3324dc2a96a1d5766dff`.
- **Fork receipt:** `acb63fa878d6b280283453ce5d4b42d4ac22d4a8`.
- **Remaining:** 129 → 128.
- **Disposition:** adopt applicable changes.
- **Manual changes:** Rename encrypted scenario mask size to kMaskSize and spell out static linkage.
- **Additional decisions / behavior:** Retain 0x1000 mask size and exact decryption arithmetic; prior namespace const already had internal linkage.
- **Verification:** Full source/reference search and inverse-transform equality check passed.
- **Pending / concerns:** Compile at next checkpoint.
...
- **Fork receipt:** `bca5e50b2c86b79a529754247d2c6cfdbbc35f3b`.
- **Remaining:** 123 → 122.
- **Disposition:** adopt applicable changes.
...
- **Fork receipt:** `4e726ab12e7587210550ed89481ce1c4452ca521`.
- **Remaining:** 120 → 119.
- **Disposition:** history receipt.
...
- **Fork receipt:** `df70c8c9276e6fee6a14e353a9174082b34865cf`.
- **Remaining:** 117 → 116.
- **Disposition:** adopt applicable changes.
...
- **Fork receipt:** `c1a1a036527dd33cdaeb4f848b84487dcbd69669`.
- **Remaining:** 115 → 114.
- **Disposition:** history receipt.
...
### U248 — `1e8d8707c0` — Fix partial/no car drawn on vehicle tab if ride has <1 cars per train (#26992)

- **Source:** `1e8d8707c08fd654fc9e628944a44c38e67d3c32`.
- **Fork receipt:** `d6f87cc132360306d73828f951f8de246087aff6`.
- **Remaining:** 114 → 113.
- **Disposition:** adopt applicable changes.
- **Manual changes:** Select the vehicle-tab icon using zero_cars + 1 instead of current train length; add changelog fix.
- **Additional decisions / behavior:** Adopt upstream representative-car selection for the tab icon. This can select a different tab sprite even on longer trains; it does not change actual train length, ride car assignment, seats or simulation.
- **Verification:** Full source and draw context inspected; only tab-icon lookup and changelog change. B54 build pending.
- **Pending / concerns:** Representative ride-object icon rendering, especially zero-car offsets, awaits interactive verification; standing limits remain.
...
- **Fork receipt:** `f2c4bd1cf796bfa801ad53efba69e2b2488be5d8`.
- **Remaining:** 111 → 110.
- **Disposition:** adopt applicable changes.
...
- **Fork receipt:** `82a083e3f347d394865acc1f52763281720fbce8`.
- **Remaining:** 101 → 100.
- **Disposition:** history receipt.
...
- **Fork receipt:** `3b06fa75fe95078d25800a5718e98700d84d44e1`.
- **Remaining:** 96 → 95.
- **Disposition:** adopt applicable changes.
...
- **Fork receipt:** `1ffaa290959cd1c10d23ededba68918955a70236`.
- **Remaining:** 67 → 66.
- **Disposition:** adopt applicable changes.
...
### U296 — `4be8013397` — Refactor Guest.h members and EASTEREGG_PEEP_NAME to enum class (#27038)

- **Source:** `4be80133970f12c5c72c945f2140c907ff402db0`.
- **Fork receipt:** `abaed358a16927cdc7d790d9eff41d9fa1e8f629`.
- **Remaining:** 66 → 65.
- **Disposition:** adopt applicable changes.
- **Manual changes:** Strong EasterEggPeepName enum and camelCase IntensityRange accessors across all consumers.
- **Additional decisions / behavior:** Keep 24 names/effects, kart speeds, intensity nibble packing and fork preference/happiness policy. Computed no-match sentinel changes -1 to none=255; sole station consumer still no-ops. No stored entity layout change.
- **Verification:** B75: complete source/fork code-line delta match; solution 78.12 seconds zero warnings/errors; all 51 play/save/script/language tests pass, 18.021 seconds.
- **Pending / concerns:** Individual Easter egg effects, native UI, non-Windows and live MP/replay remain standing checks.
...
- **Fork receipt:** `4ec4ceaddf53a34b87063a7a00bfb94adf33e9bd`.
- **Remaining:** 54 → 53.
- **Disposition:** adopt applicable changes.
...
- **Fork receipt:** `2ca51d54c0cf88c4ab7679b01086e9ea744e4e20`.
- **Remaining:** 44 → 43.
- **Disposition:** adopt applicable changes.
...
- **Fork receipt:** `c1468629ff936f2e574e6ac9cd6aeb604d3fc3ec`.
- **Remaining:** 33 → 32.
- **Disposition:** adopt applicable changes.
...
- **Fork receipt:** `393a6cb2917e8b5ff57b814baa19ccc93bcc8164`.
- **Remaining:** 29 → 28.
- **Disposition:** history receipt.
...
- **Fork receipt:** `30a3bcfb08f77cd530d6c81a1c006999e2c6614e`.
- **Remaining:** 24 → 23.
- **Disposition:** adopt applicable changes.
...
- **Fork receipt:** `ca1e45b5d2c53400331430f7399b16a2d1824263`.
- **Remaining:** 14 → 13.
- **Disposition:** adopt applicable changes.
...
- **Fork receipt:** `158978fef068dcde88e95b9c633f5b2278965b10`.
- **Remaining:** 9 → 8.
- **Disposition:** adopt applicable changes.
...
## Post-deployment audio review and owner acceptance — 2026-09-14

The owner reported possibly missing/quieter kart and coaster mechanical sounds. The [audio audit](audio-regression-audit-2026-09-14.md) found preserved source calibrations, no audio property differences across 2,505 installed object JSONs, and no reintroduced same-sample quota. A new 1,024-copy mixer regression test and all 27 focused audio tests passed. Corrected native before/after runs both mixed 462-535 channels with every vehicle candidate selected, zero vehicle start failures, and limiter gain 1.000. Existing finite ceilings and low-speed engine cutoff are documented; no production audio changes were made.

The owner subsequently double-checked the deployed game, accepted it as stable and explicitly authorized the merge in preparation for Vulkan. Their possible distance/camera/directional balance tuning is a separate future change, not grounds to alter the accepted migration or fold audio design changes into renderer work. See the deployment record and Vulkan plan for the final accepted integration checkpoint.
